...
let
  sources = {
    ...
    "@yeger/vue-lib-adapter-1.1.1" = {
      name = "_at_yeger_slash_vue-lib-adapter";
      packageName = "@yeger/vue-lib-adapter";
      version = "1.1.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@yeger/vue-lib-adapter/-/vue-lib-adapter-1.1.1.tgz";
        sha512 = "Yk/vYI0UtcWV4IW1lCI/j+dZng33Q+N1N9+Fo9JQsUWgTlRATdwhQi91PAHeys0VtLIYkFw9I2FWEB+N/O+c3Q==";
      };
    };
    "@yeger/vue-masonry-wall-4.2.1" = {
      name = "_at_yeger_slash_vue-masonry-wall";
      packageName = "@yeger/vue-masonry-wall";
      version = "4.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@yeger/vue-masonry-wall/-/vue-masonry-wall-4.2.1.tgz";
        sha512 = "KD82rut/4uUqCwbp1fB4TxvAlqbZ+kE7axMqLduMuaq0VMaK+81H/G1JemnBlGRc9xHH638GPisDnQ/rB2g8MQ==";
      };
    };
    "@yeger/vue-masonry-wall-core-4.2.1" = {
      name = "_at_yeger_slash_vue-masonry-wall-core";
      packageName = "@yeger/vue-masonry-wall-core";
      version = "4.2.1";
      src = fetchurl {
        url = "https://registry.npmjs.org/@yeger/vue-masonry-wall-core/-/vue-masonry-wall-core-4.2.1.tgz";
        sha512 = "lamOIZjPaZyCKpb6fbwLgvxqNS41DnJcdHhD0QvZZC2twjXWKpdiHF69slhGWguSxsZo15Zv+8O3xZM3ikFIWw==";
      };
    };
    "ansi-regex-5.0.1" = {
      name = "ansi-regex";
    ...
    "prosemirror-commands-1.6.0" = {
      ...
      version = "1.6.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/prosemirror-commands/-/prosemirror-commands-1.6.0.tgz";
        sha512 = "xn1U/g36OqXn2tn5nGmvnnimAj/g1pUx2ypJJIe8WkVX83WyJVC5LTARaxZa2AtQRwntu9Jc5zXs9gL9svp/mg==";
      };
    };
    ...
    "prosemirror-transform-1.10.0" = {
      ...
      version = "1.10.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/prosemirror-transform/-/prosemirror-transform-1.10.0.tgz";
        sha512 = "9UOgFSgN6Gj2ekQH5CTDJ8Rp/fnKR2IkYfGdzzp5zQMFsS4zDllLVx/+jGcX86YlACpG7UR5fwAXiWzxqWtBTg==";
      };
    };
    ...
    "tailwindcss-3.4.13" = {
      ...
      src = fetchurl {
        ...
        sha512 = "KqjHOJKogOUt5Bs752ykCeiwvi0fKVkr5oqsFNt/8px/tA8scFPIlkygsf6jXrfCqGHz7VflA6+yytWuM+XhFw==";
      };
    };
    "thenify-3.3.1" = {
      name = "thenify";
    ...
    "vue3-click-away-1.2.4" = {
      ...
      packageName = "vue3-click-away";
      version = "1.2.4";
      src = fetchurl {
        url = "https://registry.npmjs.org/vue3-click-away/-/vue3-click-away-1.2.4.tgz";
        sha512 = "O9Z2KlvIhJT8OxaFy04eiZE9rc1Mk/bp+70dLok68ko3Kr8AW5dU+j8avSk4GDQu94FllSr4m5ul4BpzlKOw1A==";
      };
    };
    "vuedraggable-4.1.0" = {
      name = "vuedraggable";
  ...
  args = {
    name = "twasgood-self-hosted";
    packageName = "twasgood-self-hosted";
    src = ./..;
    dependencies = [
      ...
      sources."@yeger/vue-lib-adapter-1.1.1"
      sources."@yeger/vue-masonry-wall-4.2.1"
      sources."@yeger/vue-masonry-wall-core-4.2.1"
      ...
      sources."prosemirror-commands-1.6.0"
      ...
      sources."prosemirror-transform-1.10.0"
