...
<template>
    <Connected title="Articles">
        <template #header>
            <Button
                :href="route('console.articles.create')"
        ...
        >
            ...
            >
                <Link
                    :href="route('console.articles.edit', { article: item.id })"
                ...
                >
                    ...
                    <div class="px-5 py-3">
                        ...
                        <span
                            v-if="item.description.length > 255"
                        ...
                        <p
                            ...
                            class="text-gray-700 max-w-xl mt-2 truncate"
                        >
                            {{ item.description }}
                        </p>
                    </div>
