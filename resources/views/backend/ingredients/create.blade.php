    <x-backend-layout title="Créer un ingrédient" width="max-w-2xl">
        <form action="{{ route('console.ingredients.store') }}" method="post">
            @csrf
            ...
            <div class="mt-4">
                ...
                <x-input name="name" placeholder="Cacao" type="text" class="mt-0.5" />
