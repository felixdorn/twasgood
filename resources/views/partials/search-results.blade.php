    ...
    <div class="bg-white max-w-lg mx-auto mt-4 rounded-xl relative w-full shadow-xl">
        ...
        <ul>
            ...
            <li>
                <a href="{{ route('recipes.show', [ "recipe" => $recipe->slug->slug ]) }}"
                    ...
                    <div>
                        ...
                        <p class="block text-gray-700 max-w-[21ch] sm:max-w-[calc(32rem-6rem)] truncate mt-0.5 pr-4">
                            {{ $recipe->description }}
                        </p>
                    </div>
                </a>
            ...
            <li class="bg-gray-50 rounded-b-xl px-4 py-2.5 mt-[4px]">
                <a id="show-all-results" class="underline lg:no-underline lg:hover:underline" href="{{ route('search', ["query" => $query]) }}">
