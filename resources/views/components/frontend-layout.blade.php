                ...
                <ul class="w-full grid grid-cols-2 lg:flex lg:space-x-6 items-center">
                    <li class="flex-1">
                        ...
                        <a class="hover:underline whitespace-nowrap" href="/">
                            <span class="font-bold text-xl text-brand-600">Faire + Acheter -</span>
                        </a>
                    </li>
                    ...
                    <li class="text-right lg:w-fit lg:order-last">
                        <a href="{{ route('about-us') }}" class="whitespace-nowrap text-gray-700 hover:underline">À
                            propos</a>
                    </li>
                </ul>
            </div>
                    ...
                    @foreach ($categories as $category)
                        <li>
                            <a href="{{ route('categories.show', ['category' => $category->slug->slug]) }}"
                                class="text-gray-700 whitespace-nowrap underline lg:no-underline hover:underline focus:underline block lg:text-lg">
                                {{ $category->name }}
                            </a>
                        </li>
                    @endforeach
        ...
        <div class="max-w-7xl mx-auto">
            <div class="py-6 lg:flex lg:justify-between">
                ...
                <ul class="flex  space-x-4  lg:space-x-0 lg:block items-center lg:space-y-3 mt-4 lg:mt-0">
                    <li>
                        <a class="flex underline lg:no-underline hover:underline items-center text-[#0865ff]"
                    ...
                    <li>
                        <a class="underline lg:no-underline hover:underline flex items-center text-[#e7476b]"
